...
class CityServiceViewModel : ObservableObject{
    ...
    @Published var cityService = [
        CityService(name: "Hoda hospital",
                    address: "1th district",
                    branches: ["Mohandsin","Alex","October"],
                    category: "Hospital", imgURL: "hodaHospital",
                    facbookURL: URL(string:"https://www.google.com/?client=safari&channel=iphone_bm")!,
                    instgramURL: URL(string:"https://www.google.com/?client=safari&channel=iphone_bm")!,
                    phoneNumber: 0103445345,
                    rating: 3.5),
        CityService(name: "Galaxy cinema",
                    address: "Hossary",
                    branches: ["October","Manial"],
                    category: "Cinema",
                    imgURL: "galaxyCinema",
                    facbookURL: URL(string:"https://www.google.com/?client=safari&channel=iphone_bm")!,
                    instgramURL: URL(string:"https://www.google.com/?client=safari&channel=iphone_bm")!,
                    phoneNumber: 0103445345,
                    rating: 2),
        CityService(name: "Golds gym",
                    address: "7th district",
                    branches: ["Rehab","October","Alex","Zamalek","Zayed"],
                    category: "Gym",
                    imgURL: "goldsGym",
                    facbookURL: URL(string:"https://www.google.com/?client=safari&channel=iphone_bm")!,
                    instgramURL: URL(string:"https://www.google.com/?client=safari&channel=iphone_bm")!,
                    phoneNumber: 0103445345,
                    rating: 5),
        CityService(name: "Pioneer international school",
                    address: "8th district",
                    branches: ["October","Mohandsinn","Nasr city"],
                    category: "School",
                    imgURL: "pioneerSchool",
                    facbookURL: URL(string:"https://www.google.com/?client=safari&channel=iphone_bm")!,
                    instgramURL: URL(string:"https://www.google.com/?client=safari&channel=iphone_bm")!,
                    phoneNumber: 0103445345,
                    rating: 4),
